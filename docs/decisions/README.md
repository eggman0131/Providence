...
| [0021](./0021-seeded-parameterised-worldgen.md) | Seeded, parameterised worldgen over a shape × relief space | Accepted |
| [0022](./0022-interactive-shaping-seam-input-command-simdriver.md) | The interactive shaping seam: `TerrainCommand`, `SimDriver`, and a core that consumes commands | Accepted |
| [0023](./0023-derived-terrain-snapshot-per-vertex-type.md) | The derived terrain snapshot grows a per-vertex terrain-type channel | Accepted |
